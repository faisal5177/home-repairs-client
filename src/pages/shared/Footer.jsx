    ...
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-12 rounded-t-3xl">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-3">
              Ensuring quality homecare services with compassion and expertise.
              We are here to make life easier and better for your loved ones.
            </p>
          </div>
        ...
        <div className="text-center text-gray-400 mt-6">
          <p>
            © {new Date().getFullYear()} Homecare Solutions. All Rights
            Reserved.
          </p>
        </div>
      </div>
